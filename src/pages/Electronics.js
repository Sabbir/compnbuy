...
function classNames(...classes) {
  ...
  const navigation = [
    { name: 'Groceries', id:0, href: '/#', current: false, disb: true },
    { name: 'Clothes', id:1, href: '/clothes/#', current: false, disb: true },
    { name: 'Electronics', id:2, href: '/electronics/#', current: true, disb: false },
    ...
    render(){
      ...
      const handleTrack = () => {
        if (q.length !== 0) {
          ...
          getProducts("http://localhost/load/api/v1/eproducts/"+ q)
       //  getProducts("https://comp-nbuy.com/load/api/v1/eproducts/"+ q)  
          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                      ...
                      <div className="ml-6 flex items-baseline space-x-4">
                        {navigation.map((item) => (
                          <a
                            ...
                            onClick= {(event) => {
                              (!isSearch&&item.id>2)? (
                              this.setState({ status: item.disb, id:2 })
                              ):(
              ...
              <div className="hidden md:block">
                    ...
                    <button
                        ...
                        onClick={() => {
                          (!isSearch)? (
                          this.setState({ status: true, id:2 })
                          ):(
